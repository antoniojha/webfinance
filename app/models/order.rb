class Order <ActiveRecord::Base
  ...
  FINANCIAL_CATEGORIES=[["Protection",1],["Retirement",3],["Investment",4],["Education Fund",5],["Estate Planning",6]]
  FINANCIAL_CATEGORIES_HASH={"1"=>"Protection","3"=>"Retirement","4"=>"Investment","5"=>"Education Fund","6"=>"Estate Planning"}  
