...
(function() {
  jQuery(function() {
    var edit_profile, update_profile;
    $("#financial_vehicles .fin_product").tooltip({
      items: "span",
      content: function() {
        var element;
        element = $(this);
        return "<div style='text-align:left;'> Company: " + element.attr("title") + "<br>Description: " + element.attr("alt") + "</div>";
      }
    });
    update_profile = function(form) {
      ...
      return $.ajax({
        ...
        success: function(data) {
          return console.log("ajax was successfully performed.");
        }
      });
    };
    edit_profile = function(edit_url, object) {
      var delete_form, edit_form;
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          $(edit_form).submit(function(event) {
            event.preventDefault();
            return update_profile($(this));
          });
          return $(delete_form).click(function(event) {
            var action, ans;
            event.preventDefault();
    ...
    $("#profile_infos").on("click", "a.profile_info_edit", function() {
      if ($(".profile_info_form").is(':visible')) {
        $(".profile_info_form").hide();
        return $(".profile_info_display").show();
      } else {
        $(".profile_info_form").show();
        return $(".profile_info_display").hide();
      }
    });
    $("#profile_infos").on("submit", "form#profile_info_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    $("#abouts").on("click", "a.about_edit", function() {
      if ($(".about_form").is(':visible')) {
        $(".about_form").hide();
        return $(".about_display").show();
      } else {
        $(".about_form").show();
        return $(".about_display").hide();
      }
    });
    $("#abouts").on("submit", "form#about_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    $("#skills").on("click", "a.skills_edit", function() {
      if ($(".skills_form").is(':visible')) {
        $(".skills_form").hide();
        return $(".skills_display").show();
      } else {
        $(".skills_form").show();
        return $(".skills_display").hide();
      }
    });
    $("#skills").on("submit", "form#skills_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    ...
    $("#licenses").on("click", "a.licenses_edit", function() {
      return $("#license_dialog_form").dialog("open");
    });
    $("#financial_vehicles").on("click", "a.financial_vehicle_edit", function() {
      return $("#financial_vehicle_dialog_form").dialog("open");
    });
    ...
    $("#financial_vehicle_dialog_form").on("submit", "form#vehicle_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    ...
    $("#financial_vehicles").on("click", "a.fin_product_add", function() {
      return $("#fin_product_add_dialog_form").dialog("open");
    });
    $("#fin_product_add_dialog_form").on("submit", "form#fin_product_add_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    ...
    $("#financial_vehicles").on("click", "a.fin_product_edit", function() {
      var edit_url, id;
      id = $(this).attr("id");
      edit_url = "/financial_products/" + id + "/edit";
      return edit_profile(edit_url, "fin_product");
    });
    ...
    $("#educations").on("click", "a.education_add", function() {
      return $("#education_add_dialog_form").dialog("open");
    });
    $("#education_add_dialog_form").on("submit", "form#education_add_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    ...
    $("#educations").on("click", "a.education_edit", function() {
      var edit_url, id;
      id = $(this).attr("id");
      edit_url = "/educations/" + id + "/edit";
      return edit_profile(edit_url, "education");
    });
    ...
    $("#experiences").on("click", "a.experience_add", function() {
      return $("#experience_add_dialog_form").dialog("open");
    });
    $("#experience_add_dialog_form").on("submit", "form#experience_add_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    ...
    $("#experiences").on("click", "a.experience_edit", function() {
      var edit_url, id;
      id = $(this).attr("id");
      edit_url = "/experiences/" + id + "/edit";
      return edit_profile(edit_url, "experience");
    });
    ...
    $("#financial_stories").on("click", "a.financial_story_add", function() {
      return $("#fin_story_add_dialog_form").dialog("open");
    });
    $("#fin_story_add_dialog_form").on("submit", "form#fin_story_add_form", function(event) {
      event.preventDefault();
      return update_profile($(this));
    });
    ...
    return $("#financial_stories").on("click", "a.fin_story_edit", function() {
      var edit_url, id;
      id = $(this).attr("id");
      edit_url = "/financial_stories/" + id + "/edit";
      return edit_profile(edit_url, "financial_story");
    });
  });
...
(function() {
  jQuery(function() {
    ...
    return $("#save_story").button().on("click", function() {
      return save_story_form.dialog("open");
    });
  });
...
(function() {
  $(function() {
    $("#submit_broker_registration").submit(function(event) {
      var ans;
    ...
    return $("#broker_register_dialog").dialog({
      autoOpen: false,
      modal: true,
      buttons: {
        "Yes": function() {
          return $("#submit_broker_registration").submit();
        },
        "Cancel": function() {
...
(function() {
  jQuery(function() {
    ...
    $('#financial_stories').click(function() {
      $(".financial_stories").show();
      $(".financial_testimonies").hide();
      return false;
    });
    return $("#financial_testimonies").click(function() {
